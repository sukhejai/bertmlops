...
class Env:
    ...
    use_gpu_for_scoring: Optional[bool] = os.environ.get(
        "USE_GPU_FOR_SCORING", "false").lower().strip() == "true"
    ...
    rebuild_env_scoring: Optional[bool] = os.environ.get(
        "AML_REBUILD_ENVIRONMENT_SCORING", "false").lower().strip() == "true"
    ...
    device: Optional[str] = os.environ.get("DEVICE")  # NOQA: E501
    model_path: Optional[str] = os.environ.get("MODEL_PATH")  # NOQA: E501
    base_model_path: Optional[str] = os.environ.get("BASE_MODEL_PATH")  # NOQA: E501
